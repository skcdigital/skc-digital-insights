...
export const loadPaymentData = createServerFn({ method: "GET" })
  .validator((d: { type: string; number: string }) => d)
  .handler(async ({ data: { type, number } }): Promise<PayloadSuccess | PayloadError> => {
